...
**Живой вход Microsoft ещё не проверялся** — нужен аккаунт владельца.

Какой именно аккаунт — важно для одной поверхности. Почта, календарь и Teams работают
и на личном, и на рабочем; **содержимое книг Excel — только на рабочем или учебном**,
потому что Excel REST API не обслуживает личный OneDrive ([ONEDRIVE.md](ONEDRIVE.md)).
На личном аккаунте файлы найдутся, а чтение ячеек откажет. Экран подключений говорит
это рядом с кнопкой «Разрешить OneDrive», до согласия, а не после первого отказа.
