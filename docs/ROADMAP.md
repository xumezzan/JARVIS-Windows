...
| 2 Сервисы API | Asana, Notion, Teams, Excel/OneDrive; сценарий «подготовь всё к встрече» | **Начата 18.09**: Asana — четыре чтения и создание задачи с подтверждением ([ASANA.md](ASANA.md)), живой токен ещё не проверен. Notion и Teams не начаты |
