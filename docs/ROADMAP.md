...
| 2 Сервисы API | Asana, Notion, Teams, Excel/OneDrive; сценарий «подготовь всё к встрече» | **Идёт**: Asana — четыре чтения и создание задачи ([ASANA.md](ASANA.md)); Notion — три чтения и две записи ([NOTION.md](NOTION.md)); Teams — чаты, черновик и отправка с подтверждением ([TEAMS.md](TEAMS.md)); OneDrive/Excel — файлы, листы, чтение и запись диапазона ([ONEDRIVE.md](ONEDRIVE.md)). Живые токены и живой аккаунт ещё не проверены. Остались каналы Teams (согласие администратора) и сценарий «подготовь всё к встрече» |
