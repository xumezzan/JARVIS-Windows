...
- **Сервисы.** Outlook, календарь Microsoft, Fireflies, Asana, Notion, чаты Teams, файлы
  и любой MCP-сервер, манифест которого владелец прочитал и утвердил.
...
- **Каналов Teams и Excel/OneDrive.** Чаты Teams есть; чтение каналов требует согласия
  администратора тенанта и ждёт этих внешних ворот.
